% MY_UNPAD_SIGNAL Remove de padding from MY_PAD_SIGNAL
%
% Usage
%    x = MY_UNPAD_SIGNAL(y, resolution, target_sz, center)
%
% Input
...
% See Also
%    PAD_SIGNAL
function x = my_unpad_signal(x, res, target_sz, center)
    if nargin < 4
        center = 0;
    end
