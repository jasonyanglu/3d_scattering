...
function [U_Phi, U_Psi] = wavelet_layer_3d_pyramid_nods(...
    ...
    if (calculate_psi) % first application
        ...
        for p = 1:numel(U_orb.signal)
            ...
            [y_Phi, y_Psi, meta_Phi, meta_Psi] = wavelet_3d_pyramid_nods(U_orb.signal{p},...
        ...
        for p = 1:numel(U_orb.signal)
            ...
            y_Phi = wavelet_3d_pyramid_nods(U_orb.signal{p},...
                filters, filters_rot, w_options);
